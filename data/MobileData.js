const productData = [
    {
      ...
      ratings : 3,
      imageUrl:
        'https://images-na.ssl-images-amazon.com/images/I/41ddMNyQe6L.jpg',
      features: [
    ...
    },
    {
      ...
      imageUrl:
        'https://www.t-mobile.com/content/dam/t-mobile/en-p/cell-phones/samsung/samsung-galaxy-s9-plus/lilac-purple/Samsung-Galaxy-S9-Plus-Lilac-Purple-2-3x.jpg',
      features: [
        'Super slow motion',
        'Personal emojis', 
        'Improved security',
    ...
    },
    {
      ...
      imageUrl:
        'https://www.91-img.com/pictures/lenovo-p2-3gb-ram-mobile-phone-large-1.jpg',
      features: [
